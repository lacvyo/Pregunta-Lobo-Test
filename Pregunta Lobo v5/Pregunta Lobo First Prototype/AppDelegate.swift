...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //Archivos
        ...
        var calendarFile = WriteToTextFile(fileNameEntered: "Calendar.txt")
        var savedEventFile = WriteToTextFile(fileNameEntered: "savedEvent.txt")
    ...
    func application(_ application: UIApplication,
        ...
        if launchBefore {
            ...
            TopicDataHandler.saveObject(topic: "CAM")

            CoreDataHandler.saveObject(id: ("BienvenidoPL"), department: ("CAM"), title: ("Bienvenido a Pregunta Lobo"), message: ("Aqui se presentaran las notificaciones a los departamentos que estes suscrito"), active: true)
    ...
    func saveContext () {
        ...
        func checkFileWhenAppStarts() {
            if !exportFile.fileIsEmpty() {
                SocketIOManager.sharedInstance.sendMessage(message: String(exportFile.readFile()))
        ...
        func checkFileWhenAppCloses() {
            ...
            if exportFile.fileIsEmpty() {
                ...
                calendarFile.copyFile("Archivo_A_Exportar.txt")
                savedEventFile.copyFile("Archivo_A_Exportar.txt")
                ...
                mapFile.ereaseFile()
                calendarFile.ereaseFile()
                savedEventFile.ereaseFile()
