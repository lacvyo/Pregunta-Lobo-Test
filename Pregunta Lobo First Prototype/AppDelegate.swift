...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //Esta es la funcion que estaremos llamando desde el view controller de los switches, aqui podemos alterar que y cuando pasa con los topicos.
    /*func application(_ application: UIApplication, didRegister notificationSettings: UIUserNotificationSettings) {
     
     print("Registered!")
     FIRMessaging.messaging().subscribe(toTopic: "/topics/Notifications")
     print("Notification Topic")
     
     FIRMessaging.messaging().subscribe(toTopic: "/topics/Sports")
